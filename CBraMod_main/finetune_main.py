...
def main():
    ...
    parser.add_argument('--datasets_dir', type=str,
                        default='/home/user/canWeReally/data/processed_data/database/processed_average',
                        help='datasets_dir')
    parser.add_argument('--num_of_classes', type=int, default=4, help='number of classes')
    parser.add_argument('--model_dir', type=str, default='/home/user/canWeReally/weights/finetuned', help='model_dir')
    """############ Downstream dataset settings ############"""
    ...
    parser.add_argument('--foundation_dir', type=str,
                        default='/home/user/canWeReally/weights/cbramod_pretrained_weights.pth',
                        help='foundation_dir')
