...
root_dir = '/var/datasets/physionet.org/files/MI/files/eegmmidb/1.0.0'
files = [file for file in os.listdir(root_dir) if file.startswith('S')]
files = sorted(files)
...
db = lmdb.open('/home/user/canWeReally/data/processed_data/database/processed_average', map_size=4614542346)
