...
# ── Global config ─────────────────────────────────────────────
PROJECT_NAME="DREAMER_dove_sei"
BASE_SAVE_DIR="../../../experiments/DREAMER_dove_sei/grid_E"
MAIN_SCRIPT="../../../main.py"
DATA_FILE_NAME="dreamer_eeg_quadrants_wo_cross_10s_cbramod_2.pt"
...
run_experiment() {
    ...
    local cmd="uv run ${MAIN_SCRIPT} \
        --backbone ${MODEL} \
        --backbone-weights ${DATA_ROOT}/disentangleData/weights//${MODEL}_pretrained_weights.pth \
