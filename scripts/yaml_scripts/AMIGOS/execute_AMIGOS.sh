...
# ── Global Environment ───────────────────────────────────────
PROJECT_NAME="AMIGOS_NO_BACKBONE"
BASE_SAVE_DIR="../../../experiments/AMIGOS_NO_BACKBONE"
MAIN_SCRIPT="../../../main.py"
DATA_FILE_NAME="amigos_eeg_quadrants_10s_cbramod_2.pt"
...
run_experiment() {
    ...
    uv run "${MAIN_SCRIPT}" \
      ...
      --exclude-subjects 40 16 24 32 23 \
      --epochs "${epochs}" \
