...
def process_sleepedfx_data(args):
    ...
    for idx, file_pair in enumerate(tqdm(filelist)):
        ...
        X = epochs.pick(channels).get_data()
        ...
        # added by me in this last commit
        Zxx = np.concatenate(X, axis=0)
...
if __name__ == "__main__":
    ...
    """Example usage:
    python data/data_preparation/create_sleepedfx.py -d /var/datasets/physionet.org/files/sleep-edfx/1.0.0/sleep-cassette -o /home/user/canWeReally/data/processed_data --fs 128 --pick Fpz-Cz --step-size 16 --nfft 256
    """